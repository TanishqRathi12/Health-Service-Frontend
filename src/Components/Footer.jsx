...
function Footer() {
  return (
    <>
    <section class="relative overflow-hidden bg-gray-800 h-vh mt-10 sm:mt-80">
      ...
      <div class="w-auto p-8">
        <a href="#">
          <div class="inline-flex items-center">
            ...
            <span class="ml-4 text-white font-bold">Health-Services</span>
          </div>
        </a>
      </div>
      <div class="w-auto p-8">
        <ul class="-m-5 flex flex-wrap items-center">
          <li class="p-5">
            <a class="rounded-md bg-transparent px-3 py-2 font-medium text-white hover:bg-gray-700" href="#">
              Privacy Policy
            </a>
          </li>
          <li class="p-5">
      ...
      <div class="w-auto p-8">
        <div class="-m-1.5 flex flex-wrap">
          <div class="w-auto p-1.5">
            <a href="https://www.instagram.com/rathitanishq/">
              <div class="flex h-10 w-10 items-center justify-center rounded-full border border-white hover:border-gray-400">
                <svg
                  width="8"
                  height="76"
                  viewBox="0 0 8 14"
